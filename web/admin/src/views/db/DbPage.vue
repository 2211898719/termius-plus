...
import DbContentPage from "@/views/db/DbContentPage.vue";
    ...
    <a-spin :spinning="spinning" tip="等待中...">
      <a-tabs style="width: 100%;"
        ...
        <a-tab-pane tab="服务器" class="server-pane" key="server" :closable="false">
          <DbListPage ref="serverListRef" @openServer="handleOpenServer"></DbListPage>
        </a-tab-pane>
            ...
            <template v-slot:tab>
              <a-dropdown :trigger="['contextmenu']" class="dropdown">
                <div style="display: flex;justify-content: center;align-items: center;">
                  ...
                  <div class="ml5">{{ server.connName }}</div>
                </div>
                <template #overlay>
                  <a-menu>
