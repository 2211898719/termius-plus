 ...
 */
public class CurrentAuthKeyboardInteractive
        extends AbstractAuthMethod {

    private final ChallengeResponseProvider provider;

    public CurrentAuthKeyboardInteractive(ChallengeResponseProvider provider) {
        ...
        if (cmd != Message.USERAUTH_60) {
            ...
            try {
                ...
                for (int i = 0; i < numPrompts; i++) {
                    ...
                    userReplies[i] = new CharArrWrap(provider.getResponse(prompt, false));
                }
